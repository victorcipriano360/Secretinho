...
export default function NotFound() {
  return (
    <div className="mx-auto max-w-md rounded-lg border border-black/10 bg-white p-8 text-center shadow-sm">
      ...
      <h1 className="mt-2 text-2xl font-bold text-zinc-950">Perfil não encontrado</h1>
      <p className="mt-2 text-sm text-zinc-600">Confira o @ ou volte para buscar outros usuários.</p>
      <Link
        href="/"
